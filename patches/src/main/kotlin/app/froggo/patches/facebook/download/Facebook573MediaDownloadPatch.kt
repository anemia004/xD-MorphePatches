...
val downloadFacebookMedia573Patch = bytecodePatch(
    ...
    execute {
        ...
        // ---- NEW: shared DownloadManager helper for Feed video + Reels ----
        val froggoEnqueueHelper = ImmutableMethod(
            ...
            addInstructions(
                ...
                """
                    ...
                    invoke-virtual {v2, p4, v1}, Landroid/app/DownloadManager${'$'}Request;->setDestinationInExternalPublicDir(Ljava/lang/String;Ljava/lang/String;)Landroid/app/DownloadManager${'$'}Request;
                    move-result-object v2
                    ...
                    move-result-object v1
                    if-eqz v1, :froggo_enqueue_no_cookie
