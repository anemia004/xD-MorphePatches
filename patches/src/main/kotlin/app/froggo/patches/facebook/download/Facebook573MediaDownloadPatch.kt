...
private val downloadWorkerInstructions = """
 ...
 :froggo_story_download_owner_sanitized
    ...
    if-eqz v8, :froggo_story_dl_ext_video
    const-string v5, ".jpg"
    goto :froggo_story_dl_ext_ready
    :froggo_story_dl_ext_video
    const-string v5, ".mp4"
    :froggo_story_dl_ext_ready
    invoke-virtual {v10, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    invoke-virtual {v10}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    move-result-object v4
    if-eqz v8, :froggo_story_dl_photo_mime
    const-string v5, "video/mp4"
    const-string v6, "Movies"
    goto :froggo_story_dl_media_ready
    :froggo_story_dl_photo_mime
    const-string v5, "image/jpeg"
    const-string v6, "Pictures"
    :froggo_story_dl_media_ready
    const-string v7, "FroggoPatches/Facebook"
    move-object v2, v0
    move-object v3, v11
    invoke-static/range {v2 .. v7}, LX/WKI;->froggoEnqueue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    const/4 v15, 0x1
...
private val compactVideoDownloadWorkerInstructions = """
    ...
    const/4 v15, 0x0
    invoke-static {v0, v15}, LX/WKI;->froggoPostLocalizedDownloadSuccess(Landroid/content/Context;Z)V
    goto :froggo_video_download_finish :froggo_video_download_catch
...
val downloadFacebookMedia573Patch = bytecodePatch(
    ...
    execute {
        ...
        val froggoEnqueueHelper = ImmutableMethod(
            callbackClass.type,
            "froggoEnqueue",
            listOf(
                ImmutableMethodParameter("Landroid/content/Context;", null, null),
        ...
        callbackClass.methods.add(froggoEnqueueHelper)
