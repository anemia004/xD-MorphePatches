...
private fun compactVideoDownloadWorkerInstructions(videoPathPrefix: String) = """
    move-object v1, p0
    ...
    const-string v9, "yyyyMMdd_HHmmss'_video-01.mp4'"
...
val downloadFacebookMedia573Patch = bytecodePatch(
    ...
    execute {
        ...
        callbackClass.methods.add(storyChoiceSorry, something went wrong. Please try your request again.
