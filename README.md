...
> **[v1.0.8](https://github.com/anemia004/xD-MorphePatches/releases/tag/v1.0.8)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
| [Download Facebook Media (573)](#download-facebook-media-573) | Adds direct media downloads for Facebook 573. | • Facebook image folder<br>• Facebook video folder |
