...
> **[v1.0.11](https://github.com/anemia004/xD-MorphePatches/releases/tag/v1.0.11)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
| [Download Facebook Media (573)](#download-facebook-media-573) | Adds direct downloads for Stories and DownloadManager support for Feed/Reel video saves. | • Facebook image folder<br>• Facebook video folder |
