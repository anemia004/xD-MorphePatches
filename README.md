...
> **[v1.0.2](https://github.com/anemia004/xD-MorphePatches/releases/tag/v1.0.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
| [Download Facebook Media (573)](#download-facebook-media-573) | Adds direct downloads for the visible Story, Reel, and video media through MediaStore and DownloadManager. | • Facebook image folder<br>• Facebook video folder |
