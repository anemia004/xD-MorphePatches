...
> **[v1.0.9](https://github.com/anemia004/xD-MorphePatches/releases/tag/v1.0.9)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
| [Download Facebook Media (573)](#download-facebook-media-573) | Adds direct downloads for Stories, Reels sidebar, and Feed Videos through MediaStore and DownloadManager. | • Facebook image folder<br>• Facebook video folder |
